  ...
  return (
    <section id="intro">
      <div className="introContent">
        ...
        <span className="introText">I'm <span className="introName">Petrus</span> <br />Web Developer</span>
        <p className="introPara">A passionate and creative Web Developer with a strong drive <br /> 
